...
export const metadata: Metadata = {
  ...
  description: "Experience the finest coffee blends at Brew & Bean. Artisanal espresso, cold brew perfection, and cozy atmosphere. Visit our coffee shop today.",
  keywords: "coffee shop, premium coffee, espresso, cold brew, barista, coffee beans, cafe, specialty coffee",
  ...
  openGraph: {
    title: "Brew & Bean - Premium Coffee Shop Experience",
    description: "Experience the finest coffee blends at Brew & Bean. Artisanal espresso, cold brew perfection, and cozy atmosphere.",
    siteName: "Brew & Bean",
    type: "website",
    images: [
      {
